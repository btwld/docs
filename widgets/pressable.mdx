---
title: Pressable
description: "An interactive widget combining GestureDetector, MouseRegion, and Focus with styling capabilities."
icon: "hand-pointer"
---

`Pressable` is equivalent to Flutter's **GestureDetector**, **MouseRegion**, and **Focus** widgets but with enhanced interaction state management and styling capabilities.
