---
title: Introduction
description: "Learn what Mix is and how it transforms Flutter styling with composable, type-safe style definitions."
icon: "hand-wave"
---
...
Learn more about [styling](/guides/styling).
...
Learn more about [dynamic styling](/guides/dynamic-styling).

### Animation support

Mix supports implicit animations, phase animations (multi-step sequences), and keyframe animations. Learn more in the [animations guide](/guides/animations).
...
Learn more about [design tokens and theming](/guides/design-tokens).
