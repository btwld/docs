---
title: Design tokens
description: "Centralize visual properties with MixToken and MixScope for consistent theming."
icon: "palette"
---
...
Use the token's `call()` method to reference it in a style:
...
You can create custom token types for values not covered by built-in tokens:
